module evt {
    export class EventDispatcher {
        ...
        public rmEventListener(type: string, listener: Function, thisObject: any): void {
        ...
        public rmEventListenerByName(type: string): void {
            if (this._eventsMap == null) {
                return;
            }
            let list: Array<any> = this._eventsMap[type];
        ...
        public rmEventListenerByTarget(thisObject: any): void {
            if (this._eventsMap == null) {
                return;
            }
        ...
        public rmEventListenerByNameAndTarget(type: string, thisObject: any): void {
            if (this._eventsMap == null) {
                return;
            }
            let list: Array<any> = this._eventsMap[type];
